...
class DateUtils():
    ...
    def add_business_days(self, date, days, calendar):
        ...
        if (days > 0):
            ...
            if offset_date not in business_days:
    ...
    def end_of_month_business_day_convention(self, date):
        """
    ...
    def end_of_month_no_adjustment_business_day_convention(self, date):
        """
    ...
    def end_of_month_previous_business_day_convention(self, date, calendar):
        ...
        :return: Fecha de pago en formato datetime.date
        """
        end_of_month_day_convention = self.end_of_month_business_day_convention(date)
