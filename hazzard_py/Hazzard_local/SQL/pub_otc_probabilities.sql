...
-- Volcando estructura para tabla pub_otc.pub_otc_probabilities
CREATE TABLE IF NOT EXISTS `pub_otc_probabilities` (
  `id_default` int NOT NULL AUTO_INCREMENT COMMENT 'Id del registro insertado',
  `id_precia` char(30) NOT NULL COMMENT 'Nombre de la probabilidad default',
  `days` int NOT NULL COMMENT 'Dias',
  `pd_value` double DEFAULT NULL,
  `ps_value` double DEFAULT NULL,
...
) ENGINE=InnoDB AUTO_INCREMENT=547 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='Contiene la información calculada de la probabilidad default y probabilidades de supervivencia';
