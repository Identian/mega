...
class Interpol():
    ...
    def method(self, interpol_method):
        ...
        try:
            ...
            logger.error('[Interpolacion] No se pudo seleccionar el metodo de interpolacion. Fallo en linea: ' + error_line + '. Motivo: '+ str(e))
            raise Exception('[Interpolacion] No se pudo realizar el metodo de interpolacion')
        return case()
    ...
    def linear_interpol(self):
        ...
        try:
            ...
            raise Exception('[Interpolacion] No se pudo realizar la interpolacion')
        return y_out
