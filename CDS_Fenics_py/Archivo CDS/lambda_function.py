"""
Lambda: Trigger Colector Forwards
Esta lambda se encarga de ejecutar el Glue que recolecta el archivo de Forwards
del vendor Fecnis
"""
...
def run_glue_job(name_glue_job, instrument, valuation_date):
...
def lambda_handler(event, context):
    ...
    run_glue_job(name_glue_job, event["instrument"], event["valuation_date"])
    
    return {
        'statusCode': 200,
        'body': json.dumps('Se lanzo el proceso de recoleccion del archivo de Forwards proporcionado por Fenics')
    }